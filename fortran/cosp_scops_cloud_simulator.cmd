...
#PBS -N cosp_scops_cloud_simulator
#PBS -q ns
#PBS -m e
...
#PBS -o /perm/ms/de/sf7/cschlund/SIMULATOR/cloud_simulator/fortran/log/20160613_cosp_scops_cloud_simulator.out
#PBS -e /perm/ms/de/sf7/cschlund/SIMULATOR/cloud_simulator/fortran/log/20160613_cosp_scops_cloud_simulator.err
